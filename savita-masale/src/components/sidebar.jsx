                            ...
                            <div className="side-bar">
                                <Activity>
                                    <Nav className="side-link">
                                        ...
                                        <Nav.Link onClick={() => { scrollToId("product"), setOpen(false) }} className="">Product</Nav.Link>
                                        <Nav.Link onClick={() => { scrollToId("process"), setOpen(false) }} className="">Process</Nav.Link>
                                ...
                                <div className="side-bar-contact d-flex flex-column gap-3 mt-4">
                                    ...
                                    <ContactItem
                                        icon={<IoCallOutline />}
                                        title={"Call"}
                                        contactHerf={"tel:+917745061210"}
                                        contactValue={"7745061210"}
                                    />
                                </div>
                            </div>
                        </motion.div>
